...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(no-direct)/personal/author` | `/personal/author` | `/(no-direct)/personal/collection` | `/personal/collection` | `/(no-direct)/personal/information` | `/personal/information` | `/(no-direct)/personal/video` | `/personal/video` | `/(no-direct)/search` | `/search` | `/(tabs)/` | `/(tabs)` | `/(tabs)/subscription` | `/subscription` | `/(tabs)/user` | `/user` | `/login-modal` | `/modal`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/(no-direct)/live-play/${SingleRoutePart<T>}` | `/live-play/${SingleRoutePart<T>}` | `/(no-direct)/personal/userInfo/${SingleRoutePart<T>}` | `/personal/userInfo/${SingleRoutePart<T>}` | `/(no-direct)/video-play/${SingleRoutePart<T>}` | `/video-play/${SingleRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/(no-direct)/live-play/[liveId]` | `/(no-direct)/personal/userInfo/[targetId]` | `/(no-direct)/video-play/[videoId]`;
